...
const Sidebar = () => {
            ...
            <div className="mt-auto pt-6">
                <div className="flex gap-2">
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-full bg-[#1a1a1a] text-[#84cc16] hover:bg-[#252525] border border-gray-800 transition-all font-medium text-sm"
                    >
    ...
    return (
        <>
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-lg border-b border-white/5 px-6 py-4 flex justify-between items-center">
            ...
            {/* Desktop Sidebar */}
            <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-[240px] bg-[#0a0a0a] border-r border-gray-900 p-6 flex-col z-40">
                <SidebarContent />
            </aside>
            ...
            >
                {/* Mobile Drawer */}
                <aside
                    className={`fixed top-0 left-0 w-[240px] h-full bg-[#0a0a0a] border-r border-gray-900 p-6 flex flex-col shadow-2xl transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'
                        }`}
