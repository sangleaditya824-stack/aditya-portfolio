...
const Contact = () => {
    ...
    return (
        <section id="contact" className="py-12 md:py-20 bg-background text-white">
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold font-heading">Let's <span className="text-primary">Contact</span></h2>
                ...
                <div className="grid lg:grid-cols-2 gap-8 md:gap-10">
                    ...
                    >
                        <div className="bg-card p-6 md:p-8 rounded-2xl transition-all">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-card p-6 md:p-8 rounded-2xl relative transition-all"
                    >
                        ...
                        <form className="space-y-4 md:space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-background rounded-lg p-3 md:p-4 text-white focus:outline-none transition-colors text-sm md:text-base placeholder:text-gray-600"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full bg-background border border-white/10 rounded-lg p-3 md:p-4 text-white focus:border-primary focus:outline-none transition-colors resize-none text-sm md:text-base placeholder:text-gray-600"
                                ></textarea>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                                ...
                                <button
                                    ...
                                    className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 md:py-4 rounded-lg transition-all flex items-center justify-center gap-2 text-sm md:text-base"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.2c.8 0 1.6.1 2.3.4Z" /><path d="M17 16l4-4-4-4" /><path d="M21 12H9" /></svg>
                                    WhatsApp
                                </button>
                            </div>
                        </form>
